...
hl.bind(mainMod .. " + SHIFT + M", hl.dsp.exec_cmd(home .. "/.config/hypr/scripts/minimize-window.sh restore-last"))
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd(home .. "/.config/hypr/scripts/minimize-window.sh restore-all"))
