...
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd(home .. "/.config/hypr/scripts/toggle-wallpaper-studio.sh"))
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd(home .. "/.config/hypr/scripts/wallpaper-timer.sh random"))
hl.bind(mainMod .. " + ALT + W", hl.dsp.exec_cmd(home .. "/.config/hypr/scripts/toggle-wallpaper-studio.sh"))
hl.bind(mainMod .. " + CTRL + R", hl.dsp.exec_cmd("sh -c 'killall quickshell; ~/.local/bin/garchy-bar'"))
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd(home .. "/.config/hypr/scripts/garchy-toggle.sh btop"))
...
-- Media Keys & Audio (PipeWire wpctl + garchy_hub_service.py with live OSD)
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("python3 " .. home .. "/.config/hypr/scripts/garchy_hub_service.py vol-up"), { locked = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("python3 " .. home .. "/.config/hypr/scripts/garchy_hub_service.py vol-down"), { locked = true })
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("python3 " .. home .. "/.config/hypr/scripts/garchy_hub_service.py vol-mute"), { locked = true })
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd("python3 " .. home .. "/.config/hypr/scripts/garchy_hub_service.py toggle-mic"), { locked = true })
hl.bind("XF86AudioPlay", hl.dsp.exec_cmd("python3 " .. home .. "/.config/hypr/scripts/garchy_hub_service.py media-play-pause"), { locked = true })
hl.bind("XF86AudioNext", hl.dsp.exec_cmd("python3 " .. home .. "/.config/hypr/scripts/garchy_hub_service.py media-next"), { locked = true })
hl.bind("XF86AudioPrev", hl.dsp.exec_cmd("python3 " .. home .. "/.config/hypr/scripts/garchy_hub_service.py media-prev"), { locked = true })
